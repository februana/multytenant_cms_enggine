<?php
// Consolidated app/config.php — canonical configuration for app/
// This file is the consolidated, non-destructive runtime configuration.
// It loads optional environment files, defines safe paths, security defaults,
// and helper functions used by app endpoints. Changes in this file should
// preserve endpoint behavior and not alter public API contracts.
...
// Database path resolution (priority: env -> legacy app/storage/data -> fallback app/database.sqlite)
