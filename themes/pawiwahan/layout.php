...
<?php endif; ?>
<main>
<?php if ($sectionEnabled('about')): ?><section class="card-a" id="about"><div class="container"><div class="row text-center mb-3"><div class="col mt-3"><h2>OM Swastiastu</h2></div></div><div class="row justify-content-center fs-5 text-center"><div class="col-md-6"><p class="fst-italic"><?php echo $openingText; ?></p></div></div></div></section><?php endif; ?>
...
<section id="gift" class="card"><div class="container col-md-6"><div class="row text-center mb-3 mt-3"><div class="col"><h2>Angpao cashless</h2><p>Bagi keluarga dan sahabat yang ingin memberikan hadiah, silakan klik tombol di bawah. Terima kasih.</p></div></div><div class="row text-center mb-3 mt-0"><div class="col"><button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-gift-fill"></i> Angpao cashless</button></div></div></div></section>
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Jika memberi adalah ungkapan tanda kasih Anda, Anda dapat mengirim amplop digital secara transfer pada akun di bawah ini.</h5></div><div class="modal-body"><p><?php echo escape_html((string)($config['gift']['bank'] ?? '')); ?> — <?php echo escape_html((string)($config['gift']['account_holder'] ?? '')); ?></p><div id="container"><div id="text" class="pawiwahan-gift-number"><?php echo escape_html((string)($config['gift']['account_number'] ?? '')); ?></div><button id="copy" type="button" class="material-symbols-outlined" data-copy="<?php echo escape_html((string)($config['gift']['account_number'] ?? '')); ?>" aria-label="Salin nomor rekening"><i class="bi bi-clipboard-check"></i></button><span id="popupCopy2" class="popuptext" role="status"></span></div><p><?php echo escape_html((string)($config['gift']['e_wallet_label'] ?? '')); ?>: <?php echo escape_html((string)($config['gift']['e_wallet_number'] ?? '')); ?></p></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button></div></div></div></div>
<?php endif; ?>
