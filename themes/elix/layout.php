  ...
  <body>
    ...
    <section id="hero" class="hero w-100 h-100 p-3 mx-auto text-center d-flex justify-content-center align-items-center text-white">
      <main>
        ...
        <a href="#hero" class="btn mt-4" btn-lg onClick="enableScroll()"><i class="bi bi-envelope-open-fill me-2" aria-hidden="true"></i><span>Buka Undangan</span></a>
      </main>
    </section>
    <?php endif; ?>
    ...
    <nav class="navbar navbar-expand-md bg-transparent sticky-top mynavbar" aria-label="Navigasi undangan">
      <div class="container">
        <a class="navbar-brand elix-couple-heading" href="#hero"><span><?php echo $brideName; ?> &amp; <?php echo $groomName; ?></span></a>
