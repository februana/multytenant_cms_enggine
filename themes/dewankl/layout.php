...
// Extract semantic data from the existing CMS fields.
...
$dewanklHeadingColor = (string)($visuals['heading_color'] ?? '#2a1f1c');
$dewanklTextColor = (string)($visuals['text_color'] ?? '#2a1f1c');
$dewanklMutedColor = (string)($visuals['muted_color'] ?? '#6e5a52');
$dewanklLinkColor = (string)($visuals['link_color'] ?? '#7b4a3a');
