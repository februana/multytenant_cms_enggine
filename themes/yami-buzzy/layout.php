...
$videoPath = trim((string)($config['media']['video'] ?? $config['media']['invitation_video'] ?? ''));
...
<body class="yami-buzzy" data-countdown-target="<?php echo $countdownTarget; ?>">
  ...
  <main>
  <?php if ($sectionEnabled('couple')): ?><section id="yami-couple" class="yami-section yami-couple" data-section="couple"><div class="yami-container"><p class="yami-eyebrow">Tentang Kami</p><h2>Mempelai</h2><div class="yami-couple-grid"><article><div class="yami-avatar yami-avatar-bride" aria-hidden="true">B</div><h3><?php echo $brideName; ?></h3><p>Putri dari <?php echo $esc($config['parents']['bride_father'] ?? ''); ?> &amp; <?php echo $esc($config['parents']['bride_mother'] ?? ''); ?></p></article><div class="yami-heart" aria-hidden="true">♥</div><article><div class="yami-avatar yami-avatar-groom" aria-hidden="true">G</div><h3><?php echo $groomName; ?></h3><p>Putra dari <?php echo $esc($config['parents']['groom_father'] ?? ''); ?> &amp; <?php echo $esc($config['parents']['groom_mother'] ?? ''); ?></p></article></div></div></section><?php endif; ?>
  ...
  <?php if ($sectionEnabled('dresscode')): ?><section id="yami-dresscode" class="yami-section yami-dresscode" data-section="dresscode"><div class="yami-container"><p class="yami-eyebrow">Dress Code</p><h2>Merayakan Cinta Bersama</h2><div class="yami-dress-grid"><?php foreach ([['09.00','Sambutan Hangat','Menyambut keluarga dan sahabat'],['09.30','Mengabadikan Momen','Sesi foto bersama'],['10.00','Acara Utama','Perayaan cinta dan kebersamaan']] as $dress): ?><article><span><?php echo $dress[0]; ?></span><img src="<?php echo $esc($sourceAsset('assets/pic/dress-' . (array_search($dress, [['09.00','Sambutan Hangat','Menyambut keluarga dan sahabat'],['09.30','Mengabadikan Momen','Sesi foto bersama'],['10.00','Acara Utama','Perayaan cinta dan kebersamaan']], true) + 1) . '.png')); ?>" alt="" loading="lazy"><h3><?php echo $dress[1]; ?></h3><p><?php echo $dress[2]; ?></p></article><?php endforeach; ?></div></div></section><?php endif; ?>
