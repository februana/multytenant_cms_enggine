...
$brideNickname = $esc($semanticNames['bride_nickname']);
$groomNickname = $esc($semanticNames['groom_nickname']);
...
$videoRoleEnabled = !function_exists('theme_contract_has_media_role') || theme_contract_has_media_role($presetKey, 'love_story_video');
...
<body class="yami-buzzy" data-countdown-target="<?php echo $countdownTarget; ?>">
  <div id="yami-welcome-modal" class="yami-welcome" role="dialog" aria-modal="true" aria-labelledby="yami-welcome-title"><div class="yami-welcome-card"><p class="yami-eyebrow">Undangan Pernikahan</p><p class="yami-opening-greeting"><?php echo $openingGreeting; ?></p><h1 id="yami-welcome-title"><?php echo $brideNickname; ?> &amp; <?php echo $groomNickname; ?></h1><p>Selamat datang. Terima kasih telah meluangkan waktu untuk merayakan hari istimewa kami.</p><button type="button" id="yami-start-button">Buka Undangan</button></div></div>
  <header class="yami-header"><a class="yami-brand" href="#yami-home" aria-label="Kembali ke beranda"><?php echo $brideNickname; ?> <span>&amp;</span> <?php echo $groomNickname; ?></a><nav aria-label="Navigasi undangan"><a href="#yami-home">Beranda</a><?php if ($sectionEnabled('couple')): ?><a href="#yami-couple">Mempelai</a><?php endif; ?><?php if ($sectionEnabled('event')): ?><a href="#yami-event">Acara</a><?php endif; ?><?php if ($sectionEnabled('story')): ?><a href="#yami-story">Kisah</a><?php endif; ?><?php if ($sectionEnabled('gallery')): ?><a href="#yami-gallery">Galeri</a><?php endif; ?><?php if ($sectionEnabled('rsvp')): ?><a href="#yami-rsvp">Konfirmasi Kehadiran</a><?php endif; ?></nav><button class="yami-nav-toggle" type="button" aria-expanded="false" aria-controls="yami-nav-mobile">Menu</button></header>
  ...
  <?php if ($sectionEnabled('home')): ?><section id="yami-home" class="yami-hero yami-section-anchor" data-section="home"><div class="yami-hero-content"><p class="yami-eyebrow">Kami Akan Menikah</p><p class="yami-guest">Kepada Yth. <strong><?php echo $guestLabel; ?></strong></p><p class="yami-opening-greeting"><?php echo $openingGreeting; ?></p><h1><?php echo $brideNickname; ?> <span>&amp;</span> <?php echo $groomNickname; ?></h1><p class="yami-opening"><?php echo $openingText; ?></p><div class="yami-countdown" data-countdown="<?php echo $countdownTarget; ?>"><div><strong data-unit="days">00</strong><span>Hari</span></div><div><strong data-unit="hours">00</strong><span>Jam</span></div><div><strong data-unit="minutes">00</strong><span>Menit</span></div><div><strong data-unit="seconds">00</strong><span>Detik</span></div></div><?php if ($calendarLink !== ''): ?><a class="yami-button" href="<?php echo $calendarLink; ?>" target="_blank" rel="noopener">Simpan ke Kalender</a><?php endif; ?></div></section><?php endif; ?>
  <main>
