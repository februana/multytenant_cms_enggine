...
const inlineEventData = document.getElementById('event-data');
const eventDataPromise = inlineEventData
    ? Promise.resolve(JSON.parse(inlineEventData.textContent || '{}'))
    : fetch(EVENT_JSON_URL).then(res => {
