...
|---|---:|---:|---:|---:|---:|---|
| DewanaKL | Ya | Ya | Tidak; variable `$couplePhoto` tidak dirender | `media.cover` dan visual `hero_background` | Tidak tampil | P1: fungsi ada, UI capability gate hilang |
