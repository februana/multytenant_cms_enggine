...
parang_assert((string)($defaults['ornament_side_size'] ?? '') === '256', 'Parang side ornament default size must preserve source placement');
...
parang_contains($defaultHtml, '--cms-parang-side-size:256px', 'Default side size missing');
...
parang_contains($customHtml, '--cms-parang-side-size:320px', 'Custom side size missing');
...
parang_assert((string)($resetValues['ornament_side_size'] ?? '') === '256', 'Reset must restore side size default');
