...
2. **Preset Adaptation**: Themes (e.g., DewanaKL, Rainier, Archak, Parang, Pawiwahan, Shubh Vivah, Yami Buzzy) dynamically read their options from `theme_options.<preset_key>` and universal configuration without hardcoded data.
