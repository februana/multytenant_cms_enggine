...
function getCountdownTargetDate() {
  ...
  const targetValue = countdown.dataset.countdown || countdown.getAttribute('data-countdown') || '';
...
// Personalisasi nama tamu dari URL parameter 'to'
...
async function loadGallery(){
  ...
  try{
    ...
    // Apply lightweight CSS masonry enhancement (non-destructive)
...
// Try autoplaying audio on load; if data saver is active, disable autoplay
...
// Kick autoplay attempt after a short delay so elements have loaded
