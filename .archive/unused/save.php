...
// Ensure session cookie params are secure (config may set global defaults)
...
// Simple rate limit: at least 10 seconds between submissions per session
...
if ($website !== '') {
    // Silent bot detection: do not save, return generic success-like response
...
try {
    ...
    // Ensure visible column exists (for backward compatibility with old databases)
